...
export class Constants {
  ...
  static readonly CREDENTIALS_LOADED_EXPIRATION: number = 10 * 60_000; // 10 minutes
  static readonly SESSION_EXPIRATION: number = 10 * 60_000; // 10 minute
  ...
  static readonly PERIOD_REENTER: number = 60_000; // 10 seconds
}
